...
// Using this to increase the decrease the splash duration of InkWell
const Duration _kUnconfirmedSplashDuration = const Duration(milliseconds: 200);
const Duration _kSplashFadeDuration = const Duration(milliseconds: 300);
